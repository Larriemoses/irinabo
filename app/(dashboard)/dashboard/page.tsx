...
export default async function Dashboard() {
  ...
  return <main className="p-5 lg:p-8">
    <div className="flex flex-wrap items-end justify-between gap-4"><div><p className="text-sm text-[var(--muted)]">Wednesday, 16 September</p><h1 className="display mt-1 text-4xl text-[var(--forest)]">Company overview</h1></div><Link href="/journeys/new" className="rounded-full bg-[var(--forest)] px-5 py-3 text-sm font-bold text-white">+ Create journey</Link></div>
